...
export class AttributeGrpcController {
  ...
  private async createAttribute(body: {
  ...
  private async createAttributeByCategory(body: {
    attributeName: string;
    labelDescription: string;
    labelName: string;
    attributeType: string;
  ...
  @GrpcMethod('AttributeService', 'BulkUploadAttribute')
  private async bulkUploadAttributes(): Promise<any> {
    const res = await this.service.bulkUploadAttributes();
    return {};
  ...
  private async updateValidation(body: {
    attributeId: number;
...
export class AttributeGroupGrpcController {
  ...
  private async createAttributeGroup(body: {
  ...
  private async createAttributeGroupByCategory(body: {
    attributeGroupName: string;
    status: boolean;
    tenantId: number;
    categoryId: number;
  ...
  @GrpcMethod('AttributeGroupService', 'BulkUploadAttributeGroup')
  private async bulkUploadAttributeGroup():Promise<any> {
    const res = await this.service.bulkUploadAttributeGroup();
    return 
  }

  @GrpcMethod('AttributeGroupService', 'GetAttributeGroupByCategory')
  private async getAttributeGroupByCategory(body: {
    id: number;
  }): Promise<any> {
  ...
  private async assignAttributeToAttributeGroups(
